...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><img src="{{ asset('/img/spc_logo.png') }}" class="img-circlel" alt="User Image"> SAN PEDRO COLLEGE</a></h1>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>SAN PEDRO COLLEGE ONLINE ENROLMENT</h1>
          <h2>LOVE SERVES</h2>
        </div>
      </div>
      <div class="text-center">
        <a href="/applicant" class="btn-get-started scrollto" style="font-size: 25px">Enroll Now</a>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">Department logo</a></h4>
